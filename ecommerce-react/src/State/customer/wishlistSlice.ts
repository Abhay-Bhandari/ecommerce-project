...
import type { Wishlist, WishlistState } from "../../types/WishlistType";
...
export const addProductToWishlist = createAsyncThunk("wishlist/addProductToWishlist", async ({productId}: {productId: number}, {rejectWithValue}) => {
  try {
