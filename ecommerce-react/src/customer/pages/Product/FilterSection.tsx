...
function FilterSection() {
  const [expendColor, setExpentColor] = useState(false);
  const [searchParams, setSearchParams] = useSearchParams();
  const [expandBrand, setExpandBrand] = useState(false);

  const handleColorToggle = () => {
    setExpentColor(!expendColor);
  };
        ...
        <section>
          ...
          <div>
            <button
              ...
              className="text-primary-color cursor-pointer hover:text-teal-600 flex items-center"
            >
